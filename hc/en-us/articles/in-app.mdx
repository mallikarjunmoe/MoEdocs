...
For more information, refer to [MoEngage Templating Language (JINJA)](https://help.moengage.com/hc/en-us/articles/115002757783).

<AccordionGroup>
  <Accordion title="Test Campaign (optional)">
    Test campaigns enable you to preview the campaign on a test device. You can test by User ID, Email, Device ID, and more. For details, see [Testing In-App Campaign](https://help.moengage.com/hc/en-us/articles/360047789092).
    <Frame>
