---
title: "Create an In-App Message Campaign" description: "Learn how to create, configure, target, and schedule In-App message campaigns to engage your users effectively."
---
...
<Frame>
<img src="/guide-media/01HVPRFWNJQQZG2SKA89N1WDMP" alt="Create campaign from campaigns page" />
</Frame>
</Step>
<Step title="Select In-App Campaign">
From the campaign types, under Inbound, select In-App.
<Frame>
<img src="/guide-media/01JV4GP36F9645M4F1KH34J7N2" alt="Select In-App campaign type" />
</Frame>
</Step>
</Steps>
...
<Frame>
<img src="/guide-media/01HTDXCETGSPVK2A1ATYZYPV4F" alt="Campaign details section" width="454" height="202" />
</Frame>
...
<Frame>
<img src="/guide-media/01HTDXFNF84KY8R7FT8NZY6CN5" alt="platforms.png" width="417" height="114" />
</Frame>
...
<Frame>
<img src="/guide-media/01JNDSB8RP6ZVAAMCPE8B18M9B" alt="On session start trigger option" />
</Frame>
...
<Frame>
<img src="/guide-media/01JNDSQNXH6MMJB7B7TBFB25YN" alt="On screen load trigger option" />
</Frame>
...
- Specific screens: Configure the screens or app context based on the platforms you selected.
...
<Frame>
<img src="/guide-media/01JNDTY4R0XSPKYYWHQ06D6SND" alt="On custom event trigger" />
</Frame>

#### **IF user**
Select the event condition for your campaign. You can add multiple events and attributes.
<Frame>
<img src="/guide-media/01JNDVCMEMED4NDX5PTQQYN2XW" alt="Adding multiple triggers for a custom event" />
</Frame>

#### **AND then**
You can add more customization by stringing multiple events together using the **+ Filter** button.
<Frame>
<img src="/guide-media/01JNDVVYXQ5SZWEHWNZPHJ4ECF" alt="Using 'AND then' to chain events" />
</Frame>

#### **THEN**
Under **Trigger the message**, select **Immediately** or **After Delay** to define when to display the message.
<Note>
...
<Frame>
<img src="/guide-media/01HVRC79X92THHDM1XYK665240" alt="Targeting all users" />
</Frame>
</Tab>
...
<Frame>
<img src="/guide-media/01GTN2Z637R1G9H92351VENX9M" alt="Filtering by user property" />
</Frame>
</Tab>
...
For more information, refer to Create Segments.
<Frame>
<img src="/guide-media/01GTN3DPHDYDBMCK1N46XF2CFC" alt="Filtering by user behavior" />
</Frame>
</Tab>
...
For more information, refer to Create Segments.
<Frame>
<img src="/guide-media/01GTN3VCBNVMGM69K713BBBF4C" alt="Filtering by user affinity" />
</Frame>
</Tab>
...
<Frame>
<img src="/guide-media/01GTN40RVG2W8SH1ZZXS77E8N8" alt="Filtering by custom segment" />
</Frame>
</Tab>
</Tabs>
...
<Frame>
<img src="/guide-media/01HTDY92QN451WG6XG0750SJYE" alt="Control group settings" />
</Frame>
...
<Frame>
<img src="/guide-media/01HCXWN134DJFKPA20K4N5FJ2F" alt="FilterandSearchOptions.gif" />
</Frame>
</Tab>
...
<Frame>
<img src="/guide-media/01HVRD82BVE5RT2GZ8HD1ZQ2AA" alt="Testing the campaign with a test user" />
</Frame>
</Accordion>
</AccordionGroup>
...
<Frame>
<img src="/guide-media/01HGAYYEMT4M29S5FKFH481EMJ" alt="In-App-DeliverySchedule_oneTime.gif" />
</Frame>
</Tab>
<Tab title="Periodic">
Send the campaign periodically on a specified date and time (daily, weekly, or monthly).
<Frame>
<img src="/guide-media/01HGAYHS07H1PCAY298BVAY07S" alt="In-App_DeliverySchedule_Periodic.gif" />
</Frame>
</Tab>
</Tabs>
...
<Frame>
<img src="/guide-media/01GTXASRNT9SC05KKY43SY9WXA" alt="ConVErsionGoals.png" />
</Frame>
