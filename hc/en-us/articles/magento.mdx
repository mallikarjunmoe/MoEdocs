---
title: "Magento"
description: "Learn how to integrate MoEngage with your Magento store"
---

# Magento

MoEngage provides comprehensive integration with Magento stores, enabling you to track customer behavior, send targeted campaigns, and analyze performance across your e-commerce platform.

## Overview

### What is Magento Integration?
The MoEngage Magento integration allows you to:
...
1. **Go to MoEngage**: Visit the MoEngage website
2. **Download Extension**: Download the Magento extension
3. **Extract Files**: Extract the extension files
4. **Upload to Server**: Upload files to your Magento server

### Step 2: Install Extension
1. **Access Admin Panel**: Log into your Magento admin panel
2. **Go to Extensions**: Navigate to System > Extensions
3. **Install Extension**: Install the MoEngage extension
4. **Clear Cache**: Clear Magento cache

### Step 3: Configure Settings
1. **Access Configuration**: Go to System > Configuration
2. **Find MoEngage**: Look for MoEngage in the configuration
...
### Debug Steps
1. **Check Installation**: Verify MoEngage extension is properly installed
