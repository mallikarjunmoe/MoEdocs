---
title: "WooCommerce"
description: "Learn how to integrate MoEngage with your WooCommerce store"
---

# WooCommerce

MoEngage provides seamless integration with WooCommerce stores, enabling you to track customer behavior, send targeted campaigns, and analyze performance across your e-commerce platform.

## Overview

### What is WooCommerce Integration?
The MoEngage WooCommerce integration allows you to:
...
1. **Go to WordPress Admin**: Log into your WordPress admin panel
2. **Go to Plugins**: Navigate to Plugins > Add New
3. **Search for MoEngage**: Search for "MoEngage" in the plugin directory
4. **Install Plugin**: Click "Install Now" to install the plugin

### Step 2: Activate Plugin
1. **Activate**: Click "Activate" to activate the plugin
2. **Configure**: Go to the plugin settings to configure
3. **Set Up Account**: Connect your MoEngage account
...
### Debug Steps
1. **Check Installation**: Verify MoEngage plugin is properly installed
